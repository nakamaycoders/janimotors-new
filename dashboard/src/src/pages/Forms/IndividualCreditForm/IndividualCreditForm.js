...
const CreditApproval = () => {
  ...
  const changeView = (id) => {
    const changeViewUrl = `https://janimotors-api.onrender.com/api/credit/update`;
    try {
  ...
  const url = "https://janimotors-api.onrender.com/api/credit/information";
  ...
  const deleteUrl = `https://janimotors-api.onrender.com/api/credit/delete`;
